...
insert into memo values
  ...
  (3, 'filter', 1, 0, array[0], array[6,0]),
  (6, 'scan', 0, 0, array[8,12,15,9], array[]::int[]),
  (8, 'filter', 6, 0, array[8,9,15,12], array[8,12,9]),
  (10, 'join', 3, 8, array[12,8,9,15,0], array[0,9]),
  (13, 'scan', 0, 0, array[27,22,17,23], array[]::int[]),
  (15, 'filter', 13, 0, array[17,22,23], array[27,17]),
  (19, 'join', 10, 15, array[8,12,22,17,23,15], array[8,17]);
*/

insert into memo values
  (0, 'noop', 0, 0, array[]::int[], array[]::int[]) ,
  (1, 'scan', 0, 0, array[6,0], array[]::int[]),
  (3, 'filter', 1, 0, array[0,6], array[6]),
  (5, 'proj', 3, 0, array[0], array[0]),
  (6, 'scan', 0, 0, array[8,9,12], array[]::int[]),
  (8, 'filter', 6, 0, array[9,8,12], array[8]),
  (10, 'join', 5, 8, array[9,0,12,8], array[0,9]),
  (12, 'proj', 10, 0, array[12,8,9], array[12,8,9]),
  (13, 'scan', 0, 0, array[17,18], array[]::int[]),
  (15, 'filter', 13, 0, array[18,17], array[17]),
  (17, 'join', 12, 15, array[18,8,9,17,12], array[8,17]),
  (19, 'proj', 17, 0, array[8,9,12,18], array[8,9,12,18]);
...
insert into memo values
    ...
    (7, 'proj', 6, 0, array[101,702], array[101,201,301]);
*/
